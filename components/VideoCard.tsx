...
const VideoCard: NextPage<IProps> = ({ post }) => {
  ...
  //react you can use ref hook to change the state of the video to make it play or pause
  const videoRef = useRef<HTMLVideoElement>(null);


  //function that will check if video is playing it will set pause when paused else play when its paused.
  const onVideoPress = () => {
    if(playing) {
  ...
  return (
    <div className='flex flex-col border-b-2 border-gray-200 pb-6'>
      ...
      <div className="lg:ml-20 flex gap-4 relative">  {/*this is where video is uploaded, also the play and pause button will show on enter and not on leave*/}
      <div
