...
const Profile = ({ data }: IProps ) => {
    const [showUserVideos, setShowUsersVideos] = useState(true);
    ...
    <div className="w-full">
        ...
        <div className="w-16 h-16 md:w-32 md:h-32">
            ...
            <div className= "flex flex-col justify-center">
              <p className = 'md:text-2xl tracking-wider flex gap-1 items-center justify-center text-md font-bold text-primary lower'>{user.userName.replaceAll(' ','')}
